          ...
          <h1> BUKUMU </h1>
            ...
            <div className="col-md-6 col-sm-6 col-sm-pull-6">
              <div className="mu-hero-left">
                <h1> BUKUMU yang Memberikan Kemudahan Untukmu yang Suka Membaca Buku </h1>
                <p> Halaman ini akan menampilkan list buku dengan kata kunci 'Indonesia'. Dan Anda bisa langsung membacaya E-Booknya </p>
                          ...
                          <div className="col-md-3 col-sm-6">
                            <div className="mu-book-overview-single" style={{height:'550px',backgroundColor:'none'}}>
                              <span className="mu-book-overview-icon-box">
                                <img src={data.volumeInfo.imageLinks.thumbnail} style={{height:'200px'}}/>
                              </span>
